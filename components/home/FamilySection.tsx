  ...
  return (
    <section ref={ref} className="w-full">
      <div className="grid lg:grid-cols-[40%_60%]">
        <div className="flex items-center bg-ab-green px-6 py-16 sm:px-10 lg:px-14 lg:py-0">
          <RevealOnScroll>
        ...
        <div className="relative h-[46vh] min-h-[320px] lg:h-[70vh] lg:min-h-[520px]">
          <motion.div style={{ y }} className="relative h-[110%] w-full">
            <MediaImage asset={familyPhoto} tone="cream" sizes="(min-width: 1024px) 60vw, 100vw" />
          </motion.div>
