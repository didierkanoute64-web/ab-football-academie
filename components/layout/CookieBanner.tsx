      ...
      {visible && (
        ...
        >
          <div className="container-ab">
            <div className="mx-auto max-w-3xl rounded-2xl border border-ab-black/10 bg-ab-cream/95 p-6 shadow-2xl backdrop-blur-md sm:p-7">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <p className="font-display text-lg tracking-wide text-ab-black">
                    Vos données, vos droits
                  </p>
                  <p className="mt-1 font-body text-sm text-ab-black/70">
